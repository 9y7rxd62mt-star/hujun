...
def load_and_process_data(file_path):
    """加载原始 Excel 并生成特征矩阵"""
    df = pd.read_excel(r'C:\Users\15787\PycharmProjects\PythonProject\TestData_cleaned_with_features.xlsx', sheet_name='Sheet1')
...
if __name__ == "__main__":
    # 1. 加载并处理原始数据
    print("正在加载原始数据...")
    df_processed, feature_cols = load_and_process_data(r'C:\Users\15787\PycharmProjects\PythonProject\TestData_cleaned_with_features.xlsxTestData_cleaned_with_features.xlsx.xlsx')
